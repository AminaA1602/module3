# -*- coding: utf-8 -*-
"""
Created on Mon Feb  4 19:43:29 2019
...
def populate_tables(environment,db_path):
    """
    ...
    if cursor_connection != None:
        checked=check_db(db_path)
        if checked:
            ...
            print("Your database doesn't exist.")
            return False
    else:
        print("Your database may not exist or the connection is lost.")
        return False
